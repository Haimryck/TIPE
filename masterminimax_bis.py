# Implémentation minimax version 2
...
def generate_tree_recursive(node, T, L, joueur, coups, alpha, beta):
    ...
    if joueur:
        ...
        for code in T:
            ...
            child.score = generate_tree_recursive(child, T, new_L, not(joueur), coups+1, alpha, beta)
...
if __name__ == "__main__":
    ...
    dot.render("minimax_mastermind({}#{})_bis".format(colors, positions))